...
help:
	...
	@echo ""
	@echo "  health       /api/health                    [URL=$(URL)]"
	@echo "  smoke        / e /api/health                [URL=$(URL)]"
	@echo "  health-prod  /api/health em produção        [$(PROD_URL)]"
	@echo "  smoke-prod   / e /api/health em produção    [$(PROD_URL)]"
	@echo "  status       version node/pnpm e scripts"
